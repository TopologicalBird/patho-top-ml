...
In this study, we set a pipeline for the objective evaluation of distributions and test frameworks based on foundation models and topological data analysis. Our results suggest the effectiveness of topological information in enhancing performance when combined with foundation models. (Graphical image generated with ChatGPT)
